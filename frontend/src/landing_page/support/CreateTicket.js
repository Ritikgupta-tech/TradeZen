    ...
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          ...
          <br />
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Tradezen IDFC FIRST Bank 3-in-1 Account
          </a>
          <br />
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Getting Started
         ...
         <div className="col-4 p-5 mt-2 mb-2">
          ...
          <div className="col-4 p-5 mt-2 mb-2">
          <h4><i class="fa fa-plus-circle" aria-hidden="true"></i>Console</h4>
             <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Reports
          </a>
          <br />
          ...
          <div className="col-4 p-5 mt-2 mb-2">
          <h4><i class="fa fa-plus-circle" aria-hidden="true"></i>Coin</h4>
             <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Understanding Mutul Funds
          </a>
          <br />
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            About Coin
